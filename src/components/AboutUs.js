...
function AboutUs() {
    ...
    const generalPic = "/photos/general.jpg"

    let content =
      <div class="about-us">
        <h1 class="title">About us</h1>
          <AboutUsCard title = {generalTitle} description={general} image={generalPic}></AboutUsCard>
          <AboutUsCard title = {indivHelpTitle} description={individualHelp}></AboutUsCard>
          <AboutUsCard title = {campTitle} description={scienceCamp}></AboutUsCard>
      </div>
